...
This folder contains the current operating, architecture, testing and contribution guides for AIlex 1.9.
...
- [1.9.0 release scope](RELEASE_1_9_0.md) — the focused chat-intelligence changes in this release.
...
4. Compare the live-model chat evaluation against the currently deployed release for model/prompt/retrieval/context changes.
5. Confirm configuration, architecture, testing and research documentation match the shipped behavior.
...
7. Create the release using the project release workflow and verify the produced artifact.
