...
public final class AssistantService {
    ...
    /** Captures a request with trusted live metadata and no active dialogue state. */
    public PreparedRequest prepare(
        ...
        return prepare(
                player, npc, message, systemPrompt, userPrompt, trustedLiveMetadata, AssistantDialogueContext.empty()
        );
    }

    /**
     * Captures a request with optional metadata and compact active dialogue state obtained on the server thread.
    ...
    public PreparedRequest prepare(
        ...
        AssistantDialogueContext effectiveDialogue = dialogueContext == null
                ? AssistantDialogueContext.empty() : dialogueContext;
        AssistantIntentClassifier.Analysis analysis = AssistantIntentClassifier.analyze(message, effectiveDialogue);
        ...
        PreparedRequest prepared = new PreparedRequest(
                ...
                analysis, settings, retrieveKnowledge, snapshot, memory, effectiveDialogue,
