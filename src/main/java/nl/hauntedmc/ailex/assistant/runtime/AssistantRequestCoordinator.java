 ...
 */
public class AssistantRequestCoordinator {
    ...
    public record Submission(UUID requestId, Disposition disposition, UUID supersededRequestId) {
    ...
    public AssistantRequestCoordinator(Consumer<Runnable> dispatcher) {
    ...
    public synchronized boolean hasActiveRequest(UUID ownerId) {
        return activeOwners.contains(ownerId);
    }

    public synchronized List<UUID> queuedRequestIds() {
