...
/**
 * Selects the relevant part of an operator-maintained knowledge base for one chat turn.
 */
final class KnowledgeSelector {
    ...
    static String select(String knowledge, String query, int maxCharacters) {
        ...
        // Greetings and vague questions still need a small, trustworthy server baseline.
        if (selected.isEmpty()) {
