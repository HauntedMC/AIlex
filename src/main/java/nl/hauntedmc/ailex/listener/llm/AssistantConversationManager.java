 ...
 */
final class AssistantConversationManager {
    ...
    Snapshot snapshot(UUID playerId, int npcId, long timeoutMillis) {
    ...
    void recordUser(UUID playerId, int npcId, String speaker, String message) {
    ...
    void recordAssistant(UUID playerId, int npcId, String speaker, String message, AssistantIntent intent) {
        Session session = sessions.computeIfAbsent(new SessionKey(playerId, npcId), ignored -> new Session());
        synchronized (session) {
            session.lastActivityMillis = clock.getAsLong();
    ...
    ActiveTarget activeTarget(UUID playerId, long timeoutMillis) {
    ...
    boolean isLikelyFollowUp(String message, Snapshot snapshot) {
    ...
    record Snapshot(
        ...
        AssistantDialogueContext asDialogueContext() {
    ...
    record ActiveTarget(int npcId, Snapshot snapshot, long lastActivityMillis) {
    }
