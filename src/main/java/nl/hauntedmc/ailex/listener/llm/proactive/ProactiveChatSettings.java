...
/**
 * Immutable, validated view of the proactive chat section of the plugin configuration.
 */
public record ProactiveChatSettings(
    ...
    /**
     * Reads the current configuration, applying safe bounds to all timing and probability values.
     *
     * @param config plugin configuration
     * @return current proactive chat settings
     */
    ...
    /** Settings for an occasional conversation restart after the bot was quiet. */
