...
/**
 * Coordinates proactive features and owns their shared cooldown and activity state.
 * It has no model or Bukkit scheduling dependency; the caller decides how to deliver accepted triggers.
 */
public final class ProactiveChatService {
    ...
    /** Records player activity even when the message is handled by the explicit-mention flow. */
