...
public class FleePlayerAction extends MoveAction {

    private final double targetDistance = getTargetDistance();

    public FleePlayerAction(ActionContext actionContext) {
        super(actionContext);
    }
    ...
    private double getTargetDistance() {
        return ConfigHandler.getInstance().getConfig().getDouble(("npc.action.fleeplayer.targetDistance"), 10.0);
    }
}
